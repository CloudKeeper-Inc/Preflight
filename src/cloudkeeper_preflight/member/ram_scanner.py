...
def _scan_region(region: str, session) -> tuple[list[dict], list[dict]]:
    ...
    # Both directions — SELF gives what this account shares out; OTHER-ACCOUNTS
    # gives what has been shared in to this account (the "shared TGW / shared
    # subnet" pattern most enterprises depend on).

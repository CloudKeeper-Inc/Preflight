...
def assemble_output(
    ...
    return {
        ...
        "organization": org,
        "region_selection": phase1_results.get("region_selection") or {},
        ...
        "eks_access": phase1_results.get("eks_access") or {},
        "identity_center_services": phase1_results.get("identity_center_services") or {},
